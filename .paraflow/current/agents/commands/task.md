...
Use empty arrays for contribution types that do not apply. IDs must be globally unique and should be prefixed with `commands.`.
...
```json
{
  ...
  "exports": [
    {
      "id": "commands.export.ExampleSymbol",
...
- manifest.agent is exactly "commands".
- Manifest IDs are unique and prefixed with "commands." where possible.
